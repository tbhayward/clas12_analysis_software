    ...
    void run(String[] args) {
        ...
        for (current_file in 0..<n_files) {
            ...
            while (reader.hasEvent()) {
                ...
                boolean process_event = qa.pass(config_run, config_event);
                ...
                if (process_event && banks_test(event)) {
                    ...
                    for (int particle_Index = 0; particle_Index < rec_Bank.rows(); 
                        ...
                        if (particle_pid == -211 || particle_pid == -321 || particle_pid == 2212 || particle_pid == 2112 || particle_pid == -11 || particle_pid == 22) { continue; }
