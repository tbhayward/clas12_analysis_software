...
public class RadiativeBeamEnergy {
    
    protected double Ebp;

    public double get_Ebp() {
        return Ebp; // returns x
    }
    
    public RadiativeBeamEnergy (double Eb) {
    double[] beam_percentage = new double[]{0.99995, 0.98985, 0.97975, 0.96965, 0.95955, 0.94945, 0.93935, 
    ...
    double[] beam_likelihood = new double[]{0.791947, 0.808145, 0.825926, 0.838389, 0.847606, 0.855139, 
