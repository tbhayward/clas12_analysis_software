...
int main(int argc, char** argv) {
    ...
    int nv,nx,ic, ndf_im;
    {
      ...
      for(int i=0;i<nim;++i){
        ...
        else if(nm=="alpha0_H"){ init=alpha0_H; step = 0; lo=0.0; hi=1.0; }
        ...
        else if(nm=="alpha0_Ht")  { init=alpha0_Ht; step = 0; lo=0.0; hi=1.0; }
        else if(nm=="alpha1_Ht")  { init=alpha1_Ht; step = 0; }
        ...
        else if(nm=="alpha0_E")   { init=alpha0_E; step = 0;  }
        else if(nm=="alpha1_E")   {init=alpha1_E; step = 0; }
