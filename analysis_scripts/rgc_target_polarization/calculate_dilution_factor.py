...
CHARGE_FRAC = {
    "RGC_Su22": {"xNH3": 0.7631, "xC": 0.0753, "xCH2": 0.0393, "xHe": 0.0251, "xET": 0.0973},
...
def calculate_dilution_factor_temp(trees, xB_bins, use_cached=False):
    ...
    su22_df  = np.array([0.140532, 0.151063, 0.167352, 0.184508, 0.199579, 0.209084, 0.197962])
    su22_err = np.array([0.000992518, 0.000519304, 0.000593685, 0.000773525, 0.00122212, 0.00234922, 0.00613517])

    fa22_df  = np.array([0.153293, 0.158521, 0.174031, 0.189863, 0.203775, 0.214178, 0.210847])
    fa22_err = np.array([0.000359663, 0.000193648, 0.000221943, 0.000290749, 0.000462735, 0.000885529, 0.00227014])

    sp23_df  = np.array([0.151057, 0.162207, 0.177381, 0.191042, 0.203651, 0.216787, 0.221271])
    sp23_err = np.array([0.000742146, 0.000389625, 0.000448033, 0.000590651, 0.000937805, 0.00178244, 0.00446074])
    ...
    plt.xlim(0, 0.8); plt.ylim(0.10, 0.30)
    plt.legend(loc='upper right'); plt.tight_layout()
    plt.savefig("output/dilution_factor.pdf"); plt.close()
