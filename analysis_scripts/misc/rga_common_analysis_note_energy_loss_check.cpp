...
void plot_eppi0_energy_loss_Emiss2_validation(
    const char* file1,
    const char* file2,
    const char* file3,
    const char* file4,
    ...
    TString outname = TString::Format("output/eppi0_%s_energy_loss_Emiss2_validation.pdf", titleSuffix);
    c1->SaveAs(outname);
