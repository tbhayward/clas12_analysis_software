...
def main():
    ...
    # Filter to only the 5 RGC Su22 and the 5 RGC Fa22 target types
    ...
    # Compute total charge per run period (everything except the last token)
    ...
    for grp, total in filtered_totals.items():
        ...
        print(f"{grp:<30}{total:15.6f}{frac:15.2f}%")
    #endfor
