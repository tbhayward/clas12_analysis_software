...
void dilution_factors_rho(const char* nh3_file, const char* c_file) {
    ...
    TH1D *h_xF2_nh3 = new TH1D("h_xF2_nh3", "M_{x} Distribution; M_{x} (GeV); Counts", 100, -1, 1);
    TH1D *h_xF2_carbon = new TH1D("h_xF2_carbon", "M_{x} Distribution; M_{x} (GeV); Counts", 100, -1, 1);
    ...
    c1->cd(3);
    gPad->SetLeftMargin(0.15);
    TH1D *h_Mh23_nh3 = new TH1D("h_Mh23_nh3", "M_{#pi#pi} Distribution; M_{#pi#pi} (GeV); Counts", 14, 0.3, 1.5);
    TH1D *h_Mh23_carbon = new TH1D("h_Mh23_carbon", "M_{#pi#pi} Distribution; M_{#pi#pi} (GeV); Counts", 14, 0.3, 1.5);
    ...
    TF1 *fit_poly = new TF1("fit_poly", "[0] + [1]*x + [2]*x*x", 0.3, 1.5);
    ...
    c1->cd(5);
    gPad->SetLeftMargin(0.15);
    TH1D *h_xB_nh3 = new TH1D("h_xB_nh3", "M_{x (p)} Distribution; M_{x (p)}; Counts", 14, 0.0, 2);
    TH1D *h_xB_carbon = new TH1D("h_xB_carbon", "M_{x (p)} Distribution; M_{x (p)}; Counts", 14, 0.0, 2);
    ...
    // Fit to a third-degree polynomial
    TF1 *fit_poly_xB = new TF1("fit_poly_xB", "[0] + [1]*x + [2]*x*x", 0.0, 2);
