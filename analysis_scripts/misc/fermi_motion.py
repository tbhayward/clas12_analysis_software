...
# -----------------------------------------------------------------------------
# Helper to load a branch array from the PhysicsEvents tree
# -----------------------------------------------------------------------------
...
epiX_Mx2 = [(label, load_array(path, "Mx2")) for label, path in versions_epiX]
...
epiPiX_Mx2 = [(label, load_array(path, "Mx2")) for label, path in versions_epiPiX]

# -----------------------------------------------------------------------------
# 3) epi+π⁻X → Mh   (only these trees have Mh)
# -----------------------------------------------------------------------------
epiPiX_Mh = [(label, load_array(path, "Mh")) for label, path in versions_epiPiX]
