...
# ─────────────────────────────────────────────────────────────────────
# Dilution factor series (Su22, Fa22, Sp23), per group
# ─────────────────────────────────────────────────────────────────────
# ---- Su22 ----
...
# ---- Sp23 (UPDATED) ----
# Integrated (12)
Sp23_int_val = np.array([0.450827, 0.424479, 0.456888, 0.443681, 0.431808, 0.423928,
                         0.430922, 0.417182, 0.378391, 0.383784, 0.400559, 0.448328])
Sp23_int_err = np.array([0.0199276, 0.018904, 0.0157291, 0.0152947, 0.0147898, 0.0137686,
                         0.0119312, 0.0114445, 0.0111182, 0.00999146, 0.00924412, 0.0106502])

# Low xB (6)
Sp23_low_val = np.array([0.422981, 0.442469, 0.459357, 0.361746, 0.389684, 0.403234])
Sp23_low_err = np.array([0.0357986, 0.0331698, 0.0307763, 0.0298947, 0.0196631, 0.0111018])

# Mid-Low xB (6)
Sp23_midlow_val = np.array([0.421715, 0.427378, 0.405268, 0.45252, 0.363269, 0.428912])
Sp23_midlow_err = np.array([0.0267697, 0.0232818, 0.0212833, 0.014667, 0.0126776, 0.0101758])

# Mid-High xB (6)
Sp23_midhigh_val = np.array([0.420701, 0.451126, 0.423271, 0.414359, 0.38719, 0.433747])
Sp23_midhigh_err = np.array([0.0284421, 0.0194041, 0.0167923, 0.0132841, 0.011508, 0.0192561])

# High xB (6)
Sp23_high_val = np.array([0.46434, 0.470248, 0.440212, 0.430621, 0.41833, 1.04378])
Sp23_high_err = np.array([0.0227018, 0.0185814, 0.0181353, 0.0173986, 0.0236932, 0.892922])
