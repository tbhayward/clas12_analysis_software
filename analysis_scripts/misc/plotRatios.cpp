...
void plotRatios(const char* file1, const char* file2, const char* file3, const char* file4) {
    ...
    int nbins2 = 150;
    TH1F *h1_vz_p = new TH1F("h1_vz_p", "vz_p", nbins2, -8, 4);
    TH1F *h2_vz_p = new TH1F("h2_vz_p", "vz_p", nbins2, -8, 4);
    TH1F *h3_vz_p = new TH1F("h3_vz_p", "vz_p", nbins2, -8, 4);
    TH1F *h4_vz_p = new TH1F("h4_vz_p", "vz_p", nbins2, -8, 4);
