...
int main(int argc, char** argv) {
    ...
    t1->Draw("xi2>>h10_0pT06_pT2","pT2>0.0 && pT2<0.6","");
    t1->Draw("xi2>>h10_06pT16_pT2","pT2>0.6 && pT2<1.6","");

    t2->Draw("xi2>>h22_0pT06_pT2","pT2>0.0 && pT2<0.6","");
    t2->Draw("xi2>>h22_06pT16_pT2","pT2>0.6 && pT2<1.6","");
    ...
    t1->Draw("xi1>>h10_0pT06_pT1","pT1>0.0 && pT1<0.6","");
    t1->Draw("xi1>>h10_06pT16_pT1","pT1>0.6 && pT1<1.6","");

    t2->Draw("xi1>>h22_0pT06_pT1","pT1>0.0 && pT1<0.6","");
    t2->Draw("xi1>>h22_06pT16_pT1","pT1>0.6 && pT1<1.6","");
