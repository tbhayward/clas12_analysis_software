                                ...
                                const std::string& dataset = "rga_fa18_inb")
{
    ...
    const int nBinsX = 50;  // edge‐axis bins
    ...
    // six φ‐bins: three tight, three complementary
    ...
    for (auto& sp : particle_types) {
        ...
        TCanvas* c = new TCanvas(
            ...
            dataset.c_str(),  // canvas title = dataset
            1800, 1200
        );
