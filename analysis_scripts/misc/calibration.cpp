...
void plot_and_fit_parameters(const std::vector<std::pair<double, double>>& theta_bins,
    ...
    if (dataset == "rga_fa18_out" || dataset == "rga_sp18_out") {
    ...
    TF1* fit_A;
    if ((dataset == "rga_fa18_out" && prefix == "p") || (dataset == "rga_sp18_out" && prefix == "p")) {
        fit_A = new TF1("fit_A", "[0]+[1]*x", theta_bins.front().first, theta_bins.back().second);  // Linear fit for rga_fa18_out
    } else if ((dataset == "rga_fa18_out" && prefix == "#theta") || (dataset == "rga_fa18_out" && prefix == "#phi") || (dataset == "rga_sp18_out" && prefix == "#theta") || (dataset == "rga_sp18_out" && prefix == "#phi")) {
    ...
    if ((dataset != "rga_fa18_out") || (dataset == "rga_fa18_out" && prefix == "#theta") || (dataset == "rga_fa18_out" && prefix == "#phi") || (dataset != "rga_sp18_out") || (dataset == "rga_sp18_out" && prefix == "#theta") || (dataset == "rga_sp18_out" && prefix == "#phi")) {
        pt_A->AddText(Form("p2 = %.7f", fit_A->GetParameter(2)));  
    }
    if ((dataset == "rga_fa18_out" && prefix == "#theta") || (dataset == "rga_fa18_out" && prefix == "#phi") || (dataset == "rga_sp18_out" && prefix == "#theta") || (dataset == "rga_sp18_out" && prefix == "#phi")) {
    ...
    if (dataset == "rga_sp18_inb" || dataset == "rga_fa18_inb" || dataset == "rga_sp19_inb") {
        c_fit_params->cd(3);
...
void energy_loss_distributions_delta_p_fd(TTreeReader& mcReader, const std::string& dataset) {
    ...
    if (dataset == "rga_sp18_out" || dataset == "rga_fa18_out") {
        theta_bins = {
            {6.0, 12.0},  // First bin
