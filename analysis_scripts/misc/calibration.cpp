...
bool cvt_fiducial(double edge_1, double edge_3, double edge_5, double edge_7, 
    ...
    for (const auto& particle_type : particle_types) {
        ...
        TH2D* h_theta_vs_theta_data_before = new TH2D("h_theta_vs_theta_data_before", ("#theta_{CVT} vs #theta Before Cuts (Data, " + particle_latex + ")").c_str(), nBins, 0, 180, nBins, 0, 180);
        h_theta_vs_theta_data_before->GetXaxis()->SetTitle("#theta");
        h_theta_vs_theta_data_before->GetYaxis()->SetTitle("#theta_{CVT}");

        TH2D* h_phi_vs_theta_CVT_data_before = new TH2D("h_phi_vs_theta_CVT_data_before", ("#phi_{CVT} vs #theta_{CVT} Before Cuts (Data, " + particle_latex + ")").c_str(), nBins, 0, 360, nBins, 0, 180);
        h_phi_vs_theta_CVT_data_before->GetXaxis()->SetTitle("#phi_{CVT}");
        h_phi_vs_theta_CVT_data_before->GetYaxis()->SetTitle("#theta_{CVT}");

        TH2D* h_theta_vs_theta_data_after = new TH2D("h_theta_vs_theta_data_after", ("#theta_{CVT} vs #theta After Cuts (Data, " + particle_latex + ")").c_str(), nBins, 0, 180, nBins, 0, 180);
        h_theta_vs_theta_data_after->GetXaxis()->SetTitle("#theta");
        h_theta_vs_theta_data_after->GetYaxis()->SetTitle("#theta_{CVT}");

        TH2D* h_phi_vs_theta_CVT_data_after = new TH2D("h_phi_vs_theta_CVT_data_after", ("#phi_{CVT} vs #theta_{CVT} After Cuts (Data, " + particle_latex + ")").c_str(), nBins, 0, 360, nBins, 0, 180);
        ...
        if (mcReader) {
            h_theta_vs_theta_mc_before = new TH2D("h_theta_vs_theta_mc_before", ("#theta_{CVT} vs #theta Before Cuts (MC, " + particle_latex + ")").c_str(), nBins, 0, 180, nBins, 0, 180);
            ...
            h_phi_vs_theta_CVT_mc_after = new TH2D("h_phi_vs_theta_CVT_mc_after", ("#phi_{CVT} vs #theta_{CVT} After Cuts (MC, " + particle_latex + ")").c_str(), nBins, 0, 360, nBins, 0, 180);
