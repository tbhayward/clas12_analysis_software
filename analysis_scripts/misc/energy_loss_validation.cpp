...
void compareTrees(const char* file1, const char* file2, const char* output,
    ...
    // electrons
    std::vector<double> binEdges = {5,6.5,7,7.25,7.5,7.75,8,8.25,8.5,8.75,9,9.25,9.5,9.75,10.0,10.6};
    ...
    for (int i = 0; i < nBins; ++i) {
        // electron proton 
        hist1.push_back(new TH1D(Form("hist1_%d", i), "", 100, 0.7, 1.1));
        hist2.push_back(new TH1D(Form("hist2_%d", i), "", 100, 0.7, 1.1));
