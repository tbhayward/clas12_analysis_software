...
void compareTrees(const char* file1, const char* file2, const char* output, double lineValue) {
    ...
    // proton 
    std::vector<double> binEdges = {0,0.6,0.625,0.65,0.675,0.7,0.725,0.75,0.8,1.0,1.1,1.2,1.4,1.8,2.4,3.0};
    ...
    for (int i = 0; i < nBins; ++i) {
        ...
        // // proton
        hist1.push_back(new TH1D(Form("hist1_%d", i), "", 100, 0.2, 0.9));
        hist2.push_back(new TH1D(Form("hist2_%d", i), "", 100, 0.2, 0.9));
    }
