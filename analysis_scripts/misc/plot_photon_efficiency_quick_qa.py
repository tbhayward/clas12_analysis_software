...
def parse_args():
    ...
    p.add_argument(
        "--output",
        default=None,
        help="Output PNG. Default: output/photon_efficiency_quick_qa_<period>.png",
    )
    p.add_argument(
        "--no-object-cuts",
        action="store_true",
...
def main():
    args = parse_args()
    output = args.output or os.path.join("output", f"photon_efficiency_quick_qa_{args.period}.png")
