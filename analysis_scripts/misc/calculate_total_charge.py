...
if __name__ == '__main__':
    ...
    print(f"Total accumulated charge for NH3 with aligned polarizations: {charges_aligned['NH3']} nC ({fractions_aligned['NH3']:.3%} of total aligned)")
    print(f"Total accumulated charge for Carbon with aligned polarizations: {charges_aligned['C']} nC ({fractions_aligned['C']:.3%} of total aligned)")
    print(f"Total accumulated charge for CH2 with aligned polarizations: {charges_aligned['CH2']} nC ({fractions_aligned['CH2']:.3%} of total aligned)")
    print(f"Total accumulated charge for Helium Bath with aligned polarizations: {charges_aligned['Helium Bath']} nC ({fractions_aligned['Helium Bath']:.3%} of total aligned)")
    print(f"Total accumulated charge for Empty Target with aligned polarizations (run 16194): {charges_aligned['Empty Target']} nC ({fractions_aligned['Empty Target']:.3%} of total aligned)\n")

    print(f"Total accumulated charge for NH3 with unaligned polarizations: {charges_unaligned['NH3']} nC ({fractions_unaligned['NH3']:.3%} of total unaligned)")
    print(f"Total accumulated charge for Carbon with unaligned polarizations: {charges_unaligned['C']} nC ({fractions_unaligned['C']:.3%} of total unaligned)")
    print(f"Total accumulated charge for CH2 with unaligned polarizations: {charges_unaligned['CH2']} nC ({fractions_unaligned['CH2']:.3%} of total unaligned)")
    print(f"Total accumulated charge for Helium Bath with unaligned polarizations: {charges_unaligned['Helium Bath']} nC ({fractions_unaligned['Helium Bath']:.3%} of total unaligned)")
    print(f"Total accumulated charge for Empty Target with unaligned polarizations (run 16194): {charges_unaligned['Empty Target']} nC ({fractions_unaligned['Empty Target']:.3%} of total unaligned)\n")
