...
def java_el_fall2018_pass2_out(phi_local, p, sec):
    ...
    if sec == 1:
        ...
        dp = ((-3.54616e-06)*phi*phi +  2.13820e-05*phi + -0.00029815)*p*p \
           + ( 4.09174e-05*phi*phi + -0.00025837*phi +  0.00286380)*p \
           + (-9.13740e-05*phi*phi +  0.00082102*phi +  0.00818000)
        if p < 4.75:
            dp += ((-4.10350e-05)*phi*phi + -0.00034997*phi +  0.00376390)*p*p \
               + ( 2.76590e-04*phi*phi +  0.00258830*phi + -0.02738200)*p \
               + (-4.43400e-04*phi*phi + -0.00477570*phi +  0.04973700)
        else:
            dp += ( 8.06250e-06*phi*phi + -1.54450e-05*phi + -0.00213057)*p*p \
               + (-1.15274e-04*phi*phi +  0.00023844*phi +  0.03148110)*p \
               + ( 3.82370e-04*phi*phi + -0.00086500*phi + -0.11020400)
        dp += ( 8.68900e-07*phi*phi +  4.31000e-06*phi +  0.00010751)*p*p \
           + (-9.23300e-06*phi*phi + -0.00007688*phi + -0.00165270)*p \
           + ( 2.63400e-05*phi*phi +  0.00034940*phi +  0.00561220)

    elif sec == 4:
        dp = ( 2.43038e-06*phi*phi + -6.47150e-06*phi + -0.00076198)*p*p \
           + (-2.60670e-05*phi*phi +  7.12580e-05*phi +  0.00984946)*p \
           + ( 6.69394e-05*phi*phi + -0.00026416*phi + -0.00213480)
        if p < 6.5:
            dp += ( 4.35530e-06*phi*phi + -5.29650e-05*phi +  0.00053910)*p*p \
               + (-3.07090e-05*phi*phi +  0.00046773*phi + -0.00726500)*p \
               + ( 2.53100e-05*phi*phi + -0.00106190*phi +  0.02231300)
        else:
            dp += (-1.69760e-05*phi*phi +  0.00011328*phi + -0.00321020)*p*p \
               + ( 2.77220e-04*phi*phi + -0.00192533*phi +  0.05129900)*p \
               + (-0.00110380*phi*phi +  0.00811758*phi + -0.20215000)
        dp += (-3.67030e-06*phi*phi +  1.53405e-05*phi +  0.00029439)*p*p \
           + ( 4.04810e-05*phi*phi + -0.00022025*phi + -0.00364540)*p \
           + (-7.86000e-05*phi*phi +  0.00077819*phi +  0.00824600)

    elif sec == 5:
        dp = (-1.74749e-06*phi*phi +  5.20199e-05*phi +  0.00056946)*p*p \
           + ( 2.57913e-05*phi*phi + -0.00049884*phi + -0.00743872)*p \
           + (-5.94890e-05*phi*phi +  0.00070898*phi +  0.03122960)
        if p < 4.75:
            dp += (-9.64940e-05*phi*phi + -0.00051529*phi +  0.01571870)*p*p \
               + ( 6.36499e-04*phi*phi +  0.00351380*phi + -0.10917300)*p \
               + (-9.81846e-04*phi*phi + -0.00578270*phi +  0.17359200)
        else:
            dp += ( 1.31830e-06*phi*phi +  5.71120e-05*phi + -0.00267400)*p*p \
               + (-1.67340e-05*phi*phi + -0.00085909*phi +  0.03953800)*p \
               + ( 5.48500e-05*phi*phi +  0.00317812*phi + -0.14055100)
        dp += ( 3.15000e-08*phi*phi +  3.39050e-06*phi + -0.00020291)*p*p \
           + (-1.17400e-06*phi*phi + -0.00004123*phi +  0.00272570)*p \
           + ( 2.07000e-06*phi*phi +  0.00007870*phi + -0.00672860)

    elif sec == 6:
        dp = (-7.15870e-07*phi*phi +  3.31516e-05*phi + -8.78599e-05)*p*p \
           + ( 1.21201e-05*phi*phi + -0.00022942*phi +  0.00141300)*p \
           + ( 1.22200e-05*phi*phi +  0.00015445*phi +  0.01157700)
        if p < 4.75:
            dp += ( 5.32380e-05*phi*phi + -0.00034896*phi + -0.00473470)*p*p \
               + (-4.34990e-04*phi*phi +  0.00241282*phi +  0.03782400)*p \
               + ( 8.48320e-04*phi*phi + -0.00381180*phi + -0.07226300)
        else:
            dp += (-2.68850e-06*phi*phi +  1.43847e-05*phi + -0.00193047)*p*p \
               + ( 4.03300e-05*phi*phi + -0.00015816*phi +  0.02894800)*p \
               + (-1.47228e-04*phi*phi +  0.00028817*phi + -0.10448300)
        dp += (-4.34850e-06*phi*phi +  1.53884e-05*phi +  0.00028080)*p*p \
           + ( 5.20773e-05*phi*phi + -0.00021122*phi + -0.00409350)*p \
           + (-1.32679e-04*phi*phi +  0.00069139*phi +  0.01336247)
...
def plot_electron_comparison_inb(out_dir):
    ...
    fig.suptitle(r'Electron Corrections: Fall 2018 Pass 2 (in-bending) vs $J/\psi$')
    fig.tight_layout(rect=[0,0,1,0.95])
...
def plot_electron_comparison_outb(out_dir):
    ...
    fig.suptitle(r'Electron Corrections: Fall 2018 Pass 2 (out-bending) vs $J/\psi$')
    fig.tight_layout(rect=[0,0,1,0.95])
