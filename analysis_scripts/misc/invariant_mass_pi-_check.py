...
Compute and plot the invariant mass of the scattered electron and π⁺
for ep → enπ⁺ candidates, in parallel for RGC Su22, RGC Fa22, and RGC Sp23,
...
def compute_t(runnum, e_p, e_th, e_ph, p_p, p_th, p_ph):
    ...
    # scattered electron
    E_e   = np.sqrt(e_p**2 + 100000*m_pi**2)
...
def main():
    ...
    with ProcessPoolExecutor() as executor:
        futures = {
            executor.submit(analyze_period, name, path, branches, edges): name
