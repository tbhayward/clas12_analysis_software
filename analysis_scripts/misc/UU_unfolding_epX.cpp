...
int main() {
    ...
    TFile* fMCReco = TFile::Open("/volatile/clas12/thayward/multiplicities/data/epi+pi-X/rga_sp19_inb_clasdis_50nAbkg_rec_epi+pi-X.root");
    TFile* fMCGene = TFile::Open("/volatile/clas12/thayward/multiplicities/data/epi+pi-X/rga_sp19_inb_clasdis_50nAbkg_gen_epi+pi-X.root");
