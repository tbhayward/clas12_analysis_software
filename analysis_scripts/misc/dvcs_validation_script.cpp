...
void plot_elastic_energy_loss_validation(const char* file1, const char* file2, const char* titleSuffix) {
    ...
    TF1 *fit1_int = new TF1("fit1_integrated", "gaus(0) + pol2(3)", -0.01, 0.01);
    TF1 *fit2_int = new TF1("fit2_integrated", "gaus(0) + pol2(3)", -0.01, 0.01);
    ...
    for (int i = 1; i <= nBins; ++i) {
        ...
        TF1 *fit1 = new TF1(Form("fit1_%d", i), "gaus(0) + pol2(3)", -0.01, 0.01);
        TF1 *fit2 = new TF1(Form("fit2_%d", i), "gaus(0) + pol2(3)", -0.01, 0.01);
