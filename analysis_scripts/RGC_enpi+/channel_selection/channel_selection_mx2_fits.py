#!/usr/bin/env python3
"""
channel_selection_mx2_fits_v29.py
...
def execute_fit_jobs(
    ...
    print("Running channel_selection_mx2_fits_v29.py", flush=True)
...
def write_latex_nominal_tables(frame: pd.DataFrame, output_path: Path) -> None:
    ...
    lines: list[str] = []
    lines.append("% Auto-generated by channel_selection_mx2_fits_v29.py")
