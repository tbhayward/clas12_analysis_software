#!/usr/bin/env python3
"""
channel_selection_mx2_fits_v31.py
...
windows are respectively mu +/- 1 sigma, mu +/- 2 sigma, and mu +/- 3 sigma
for each run period.
...
def write_latex_nominal_tables(frame: pd.DataFrame, output_path: Path) -> None:
    ...
    lines: list[str] = []
    lines.append("% Auto-generated by channel_selection_mx2_fits_v31.py")
...
def build_final_carbon_cut_table(
    ...
    Gaussian widths and therefore receive independent 1-, 2-, and 3-sigma
    windows.
    """
    rows: list[dict[str, Any]] = []
    periods = ("su22", "fa22", "sp23")
...
def write_python_cut_lookup(
    ...
    lines = [
        ...
        'CUT_VERSION = "v21"',
        'CUT_UNITS = "GeV^2"',
        "SIGMA_MULTIPLES = {\"tight\": 1.0, \"nominal\": 2.0, \"loose\": 3.0}",
        "",
        "MX2_CUTS_GEV2 = {",
    ]
    for period in periods:
            ...
            json_safe(
                {
                    ...
                    "tight_sigma_multiple": 1.0,
                    "nominal_sigma_multiple": 2.0,
                    "loose_sigma_multiple": 3.0,
                    "periods": {
                        period: [
                            {
