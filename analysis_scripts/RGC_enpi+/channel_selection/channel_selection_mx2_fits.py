#!/usr/bin/env python3
"""
channel_selection_mx2_fits_v27.py
...
The public output is intentionally compact:
  ...
  output/channel_selection_mx2_fit_stability/
    final_carbon_assisted_cuts/
      tables/final_carbon_assisted_mx2_cuts_v27.json
      tables/final_carbon_assisted_mx2_cuts_v27.csv
      exports/final_carbon_assisted_mx2_cuts_v27.py
      exports/final_carbon_assisted_mx2_cuts_v27.h
    diagnostics/
    ...
    channel_selection_manifest_v27.json
...
def execute_fit_jobs(
    ...
    print("Running channel_selection_mx2_fits_v27.py", flush=True)
...
def write_latex_nominal_tables(frame: pd.DataFrame, output_path: Path) -> None:
    ...
    lines: list[str] = []
    lines.append("% Auto-generated by channel_selection_mx2_fits_v27.py")
...
def write_final_carbon_cut_products(
    ...
    csv_path = tables_dir / "final_carbon_assisted_mx2_cuts_v27.csv"
    json_path = tables_dir / "final_carbon_assisted_mx2_cuts_v27.json"
    python_path = exports_dir / "final_carbon_assisted_mx2_cuts_v27.py"
    cpp_path = exports_dir / "final_carbon_assisted_mx2_cuts_v27.h"
    metadata_path = exports_dir / "final_carbon_assisted_mx2_cuts_metadata_v27.json"
    comparison_plot = (
...
def run_analysis_variant(
    ...
    variant_manifest_path = output_dir / "analysis_variant_manifest_v27.json"
    variant_manifest = {
        "schema_version": 1,
...
def copy_nominal_production_products(
    ...
    canonical_csv = tables_dir / "final_carbon_assisted_mx2_cuts_v27.csv"
    canonical_json = tables_dir / "final_carbon_assisted_mx2_cuts_v27.json"
    canonical_python = exports_dir / "final_carbon_assisted_mx2_cuts_v27.py"
    canonical_cpp = exports_dir / "final_carbon_assisted_mx2_cuts_v27.h"
    ...
    compatibility_json = tables_dir / "final_carbon_assisted_mx2_cuts_v27.json"
    compatibility_csv = tables_dir / "final_carbon_assisted_mx2_cuts_v27.csv"
...
def main() -> int:
    ...
    try:
        ...
        manifest_path = root_output / "channel_selection_manifest_v27.json"
        manifest = {
            "schema_version": 2,
            "production_policy": (
