...
def run_unified_km15_final_analysis(
    ...
    for tag, cfg_bundles, label in ensemble_defs:
        ...
        for bundle in cfg_bundles:
            ...
            finite_deltas.extend(sel["delta_km15"].to_numpy(float).tolist())
        #endfor
        if finite_deltas:
...
def run_neutron_analysis(args) -> int:
    ...
    # of the nine kinematic bins and ask whether the eight-point phi dependence
    # itself is compatible with pure BH.
