...
# ---------------------------------------------------------------------------
# Default external paths copied from the C++ model_predictions.cpp conventions.
# ---------------------------------------------------------------------------
DEFAULT_DVCSGEN_DIR = "/u/home/thayward/dvcsgens/dvcsgen_print"
DEFAULT_KM15_CLI = "/u/home/thayward/clas12_analysis_software/analysis_scripts/dvcs_cross_section/km15_cli.py"
...
def draw_panel(
    ...
    if panel.pass1:
        ...
        ax.errorbar(
            ...
            linewidth=1.2,
            linestyle="None",
            label=f"{pass1_label}: stat #oplus syst #oplus 31% norm",
        )
    #endif
    ...
    if panel.pass2:
        ...
        ax.errorbar(
            ...
            linewidth=1.2,
            linestyle="None",
            label=f"{pass2_label}: stat #oplus 18% syst",
        )
    #endif
...
def main() -> int:
    ...
    if not args.skip_models:
        ...
        if args.py_km15:
            ...
            warn("PY_KM15/--py-km15 is not set; KM15 will use the current Python executable.")
        #endif
    #endif
