...
static const double FD_P_MAX = 10.6;
...
static const int VAL_NP=8;
static const int VAL_NT=3;
static const int VAL_NPH=6;
static const int VAL_NBIN=VAL_NP*VAL_NT*VAL_NPH;
static const double VAL_P_EDGES[VAL_NP+1] = {0.35,0.50,1.10,1.70,2.30,2.90,3.70,6.00,10.60};
...
void write_shoulder_diagnostics_for_fd_momentum_bins(const std::string& outdir) {
    ...
    const double p_edges[VAL_NP+1]={0.35,0.50,1.10,1.70,2.30,2.90,3.70,6.00,10.60};
...
void run_targeted_alpha_mx2_scan(
    ...
    constexpr int NA=5;
    constexpr int NM=3;
    const double p_edges[NP+1]={0.35,0.50,1.10,1.70,2.30,2.90,3.70,6.00,10.60};
...
void photon_efficiency_valerii_reproduction(int run_mode=5) {
    ...
    if (run_mode==6) {
        pe::run_valerii_fd_reproduction("output/valerii_fd_reproduction");
        return;
    } // endif
