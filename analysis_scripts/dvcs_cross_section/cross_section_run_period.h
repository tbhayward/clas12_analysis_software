...
//   1) computes a per-cell chi2 and reduced chi2 with respect to the
//      inverse-variance-weighted mean across the available run periods at each
//      phi bin,
//   2) overlays the selected period-dependent phi distributions as ratios to
//      that weighted mean in each (xB, Q2, -t) cell,
