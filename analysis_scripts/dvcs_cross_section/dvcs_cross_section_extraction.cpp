...
int main(int argc, char* argv[]) {
    ...
    // }
    for (int xB_bin = 0; xB_bin < 6; ++xB_bin) {
        plot_dvcs_data_mc_comparison(output_dir, "eppi0", "Fa18 Out", xB_bin, bin_boundaries, eppi0_readers[1], mc_rec_aaogen_readers[1], mc_gen_aaogen_readers[1]);
    }
