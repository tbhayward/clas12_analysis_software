...
static void add_pass1_fixed_systematic_columns(std::vector<std::string>& H) {
    // Filled by main_systematics.cpp from imports/pass1_systematic_summary.csv.
    // These pass-1 model/analysis systematics are preserved because they are not
    // regenerated by the pass-2 event-processing chain.
