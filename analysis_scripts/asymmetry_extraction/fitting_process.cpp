...
void performMLMFits_single_hadron(const char* output_file, const char* kinematic_file,
  ...
  for (size_t i = 0; i < numBins; ++i) {
    ...
    minuit.DefineParameter(0, "ALU_sinphi", 0.00, 0.001, -1, 1);
    minuit.DefineParameter(1, "AUL_sinphi", 0.0, 0.001, -1, 1);
    minuit.DefineParameter(2, "AUL_sin2phi", 0.0, 0.001, -1, 1);
    minuit.DefineParameter(3, "ALL", 0.0, 0.001, -1, 1);
    minuit.DefineParameter(4, "ALL_cosphi", 0.0, 0.001, -1, 1);
...
void performMLMFits_b2b_dihadron(const char* output_file, const char* kinematic_file,
  ...
  for (size_t i = 0; i < numBins; ++i) {
    ...
    minuit.DefineParameter(7, "AUL_sin2phi2", 0, 0.0, -1, 1);
    minuit.DefineParameter(8, "AUL_sinDeltaphi", 0, 0.0, -1, 1);
    minuit.DefineParameter(9, "AUL_sin2Deltaphi", 0, 0.0, -1, 1);
    minuit.DefineParameter(10, "AUL_sinSumphi", 0, 0.0, -1, 1);
