...
void performMLMFits_single_hadron(const char* output_file, const char* kinematic_file,
  ...
  for (size_t i = 0; i < numBins; ++i) {
    ...
    minuit.DefineParameter(0, "ALU_sinphi", -0.01, 0.001, -1, 1);
    minuit.DefineParameter(1, "AUL_sinphi", -0.01, 0.001, -1, 1);
    minuit.DefineParameter(2, "AUL_sin2phi", -0.01, 0.001, -1, 1);
    minuit.DefineParameter(3, "ALL", 0.30, 0.001, -1, 1);
    minuit.DefineParameter(4, "ALL_cosphi", 0.00, 0.001, -1, 1);
    minuit.DefineParameter(5, "AUU_cosphi", -0.00, 0.000, -1, 1);
    minuit.DefineParameter(6, "AUU_cos2phi", -0.00, 0.000, -1, 1);
