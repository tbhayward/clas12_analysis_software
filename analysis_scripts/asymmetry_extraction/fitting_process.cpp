...
void performChi2Fits_GeneralExclusive(const char* output_file,
  ...
  for (size_t i = 0; i < numBins; ++i) {
    ...
    // minuit.DefineParameter(7,  "F_UU_cos/F_UU",   -0.184162428,        0.00, -1.0, 1.0); 
    // minuit.DefineParameter(8,  "F_UU_cos2/F_UU",  -0.553694788,        0.00, -1.0, 1.0);  
    // minuit.DefineParameter(9,  "F_UU_sin/F_UU",   -0.098493070,        0.00, -1.0, 1.0);
    // minuit.DefineParameter(10, "F_UU_sin2/F_UU",  -0.023813757,        0.00, -1.0, 1.0);
