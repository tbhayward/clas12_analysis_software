...
void performChi2Fits_GeneralExclusive(const char* output_file,
  ...
  for (size_t i = 0; i < numBins; ++i) {
    ...
    minuit.DefineParameter(2,  "F_LU_sin/F_UU",   0.0556,  0.01,  -1.0,  1.0);
    ...
    minuit.DefineParameter(7,  "F_UU_cos/F_UU",   0.0220,  0.01,  -1.0,  1.0);
    minuit.DefineParameter(8,  "F_UU_cos2/F_UU",  -0.1524,  0.01,  -1.0,  1.0);
