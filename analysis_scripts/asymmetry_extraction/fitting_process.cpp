...
void performMLMFits_single_hadron(const char* output_file, const char* kinematic_file,
  ...
  for (size_t i = 0; i < numBins; ++i) {
    ...
    minuit.DefineParameter(0, "ALU_sinphi", 0.02, 0.0001, -1, 1);
    ...
    minuit.DefineParameter(5, "AUU_cosphi", -0.15, 0.0001, -1, 1);
    minuit.DefineParameter(6, "AUU_cos2phi", 0.0, 0.0001, -1, 1);
