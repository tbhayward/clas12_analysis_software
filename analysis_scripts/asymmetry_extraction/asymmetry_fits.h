...
double GE_model_BSA(double phi, double ALU, double B_UUcos, double C_UUcos2);
// TSA(phi) = ( AUL * sin(phi) + AUL2 * sin(2*phi) ) / GE_den(...)
double GE_model_TSA(double phi, double AUL, double AUL2, double B_UUcos, double C_UUcos2);
// DSA(phi) = ( ALL + ALL2 * cos(phi) ) / GE_den(...)
double GE_model_DSA(double phi, double ALL, double ALL2, double B_UUcos, double C_UUcos2);
