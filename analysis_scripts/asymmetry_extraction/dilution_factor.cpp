...
double dilution_factor(double currentVariable, const std::string& prefix) {
  ...
  if (prefix == "Mx") { return 0.0366071*exp(-0.5*std::pow((currentVariable-0.769794)/0.0562864),2) + 0.0260418*exp(-0.5*std::pow((currentVariable-1.1057)/0.290501),2) + 0.10761*exp(-0.5*std::pow((currentVariable-1.68863)/1.8129),2); }
