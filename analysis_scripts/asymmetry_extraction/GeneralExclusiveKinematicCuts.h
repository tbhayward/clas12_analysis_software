...
class GeneralExclusiveKinematicCuts : public BaseKinematicCuts {
public:
    explicit GeneralExclusiveKinematicCuts(TTreeReader& reader);
...
private:
    ...
    TTreeReaderValue<double> vz_e;     // azimuth of scattered electron
    ...
    TTreeReaderValue<double> vz_p;     // azimuth of pion
